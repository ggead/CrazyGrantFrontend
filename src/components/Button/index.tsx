...
const variantClasses: { [K in Variant]: string } = {
  primary: 'bg-[#00FFFF] text-[#000] text-shadow-white shadow-[inset_-2px_2px_0_0_#DB20C1,inset_2px_-2px_0_0_#B5FD14] disabled:opacity-50 hover:opacity-85',
